...
Similar to iOS ViewController pattern but for robotics

This node demonstrates:
1. Subscribing to camera images (like NotificationCenter observers)
...
class VisionRescueNode(Node):
    """
    Think of this like a UIViewController in iOS:
    - Has lifecycle methods (init, destroy)
    - Handles events (image callbacks)
    - Communicates with other components (publishers/subscribers)
    """
    ...
    def __init__(self):
        ...
        # Instance variables (like @property in iOS)
        self.frame_count = 0
    ...
    def image_callback(self, msg):
        """
        Main image processing function - like handling a UIImage in iOS
        ...
        try:
            ...
            # Optional: Display image (for debugging - like showing in UIImageView)
    ...
    def detect_potential_victim(self, cv_image):
        ...
        (This is like implementing a custom image filter in iOS)
        """
    ...
    def publish_status(self, message):
        ...
        Like posting notifications or updating UI in iOS
        """
        status_msg = String()
...
def main(args=None):
    """
    Main function - like main.swift or AppDelegate in iOS
    """
